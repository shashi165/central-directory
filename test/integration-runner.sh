...
psql <<'EOSQL'
    DROP DATABASE IF EXISTS "central_directory_integration";
	  CREATE DATABASE "central_directory_integration";
EOSQL

export CDIR_DATABASE_URI="postgres://${POSTGRES_USER}:${POSTGRES_PASSWORD}@${POSTGRES_HOST}:15432/central_directory_integration"
